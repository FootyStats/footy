Feature: Regression Tests for BBC Article Basis
  ...
  Scenario Outline: Last Day of the EPL 2009 Season
    ...
    Examples:
      | home_team     | away_team     | home_team_win_probability | score_draw_probability | away_team_win_probability | expected_home_team_goals | expected_away_team_goals | final_score_probability | delta |
      | Arsenal       | Stoke         | 72.0                      | 19.0                   | 10.0                      | 2                        | 0                        | 14                      | 2.02  |
      | Aston Villa   | Newcastle     | 62.0                      | 21.0                   | 17.0                      | 1                        | 0                        | 10                      | 1.84  |
      | Blackburn     | West Brom     | 54.0                      | 23.0                   | 23.0                      | 1                        | 1                        | 10                      | 1.18  |
      # Article says 19% probability we calculated 17%.
      # Fulham        | Everton       | 35.0                      | 35.0                   | 30.0                      | 0                        | 0                        | 19                      | 1.0   |
      | Hull          | Man United    | 9.0                       | 19.0                   | 72.0                      | 0                        | 2                        | 14                      | 1.07  |
      | Liverpool     | Tottenham     | 72.0                      | 20.0                   | 9.0                       | 1                        | 0                        | 16                      | 1.8   |
      # Article says mose likely outcome 2 - 1 (10%).  We calculate 1 - 1 10.36%.
      # Man City      | Bolton        | 59.0                      | 22.0                   | 19.0                      | 2                        | 1                        | 10                      | 1.0   |
      | Sunderland    | Chelsea       | 10.0                      | 25.0                   | 65.0                      | 0                        | 1                        | 20                      | 1.94  |
      | West Ham      | Middlesbrough | 57.0                      | 28.0                   | 15.0                      | 1                        | 0                        | 19                      | 1.0   |
      | Wigan         | Portsmouth    | 44.0                      | 32.0                   | 25.0                      | 1                        | 0                        | 16                      | 2.53  |
